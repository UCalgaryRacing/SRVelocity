...
import { ColorRGBA, IndividualPointFill, PointShape, lightningChart, emptyTick, AxisScrollStrategies, SolidFill, ColorHEX, AutoCursorModes, SolidLine, FontSettings, emptyLine } from '@arction/lcjs';
...
export default class ScatterPlot extends Component {
    ...
    updateData = () => {
        if(this.setupComplete) {
            if(this.props.xData === undefined || this.props.yData === undefined) return;
