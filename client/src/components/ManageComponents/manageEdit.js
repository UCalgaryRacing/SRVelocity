...
export default class ManageEdit extends React.Component {
  ...
  submitEdit = async () => {
    ...
    if (!status) return;
    for (var form of this.formRefs) {
      if (form !== null && form.value !== form.placeholder && form.value !== "") {
  ...
  render = () => {
    return (
      <div id="manageEdit" style={{ marginTop: "190px", paddingTop: "10px", borderTop: "1px solid", width: "100%" }}>
        <div style={{ height: "36px", lineHeight: "36px", fontSize: "20px" }}>Edit</div>
        {this.fields}
        <Button
          style={{ width: "100%", height: "36px", background: "#C22E2D", borderColor: "#C22E2D", marginTop: "10px" }}
