  ...
  render() {
    return (
      ...
      >
        ...
        >
          {this.state.approve_perms ? null : (
            <p>Sorry, you do not have the permissions to edit approvals</p>
          )}
        </div>
        <div>
        ...
        >
          {this.state.lead_perms ? null : (
            <p>Sorry, you do not have the permissions to edit leads</p>
          )}
        </div>
      </div>
    );
