...
import DataDashboard from "../dashComponents/dataDash/dataDashboard";
import Data from "../../../data";
import SensorData from "../../../constants";
import "../../styling/dashboard.css";

export default class MobileDash extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div id="dashboard">
        {/* <div
          style={{
            ...
            zIndex: "999",
            height: "60px",
            paddingLeft: this.props.leftMargin,
            paddingTop: "12px",
            background: "#F5F5F5",
            borderColor: "#C22D2D",
            borderWidth: "0",
        ...
        {this.props.typeOption === "plotting" ? (
          <MobileGraphingDashboard ref={this.graphDash} />
        ) : (
          <DataDashboard
