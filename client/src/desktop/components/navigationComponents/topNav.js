            ...
            <div style={{ textAlign: 'left' }}>
                {
                    this.state.isSignedIn ?
                        <div>
                            <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
                                <div class="container w-container"><a href="/" class="nav-link w-nav-link">Schulich Velocity</a>
                                    <nav role="navigation" class="nav-menu w-nav-menu"><a href="/streaming" class="nav-link-6 w-nav-link">Streaming</a><a href="/historical" class="nav-link-7 w-nav-link">Historical</a><a href="/manage" class="nav-link-8 w-nav-link">Manage</a><a href="signin" onClick={this.signOut} class="nav-link-9 w-nav-link">Sign Out</a><a href="/about" class="nav-link-10 w-nav-link">About</a></nav>
                        ...
                        < div >
                            <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
                                <div class="container w-container"><a href="/" class="nav-link w-nav-link">Schulich Velocity</a>
                                    <nav role="navigation" class="nav-menu w-nav-menu"><a href="/streaming" class="nav-link-6 w-nav-link">Streaming</a><a href="/signin" class="nav-link-9 w-nav-link">Sign In</a><a href="/about" class="nav-link-10 w-nav-link">About</a></nav>
                                    <div class="menu-button w-nav-button">
                                        <div class="icon w-icon-nav-menu"></div>
                                    </div>
                                </div>
