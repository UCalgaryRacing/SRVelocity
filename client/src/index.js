			...
			<React.Fragment>
				{this.state.isSignedIn ?
					<div id='topBar'>
						<div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
							<div class="container w-container"><a href="/" class="nav-link w-nav-link">Schulich Velocity</a>
								<nav role="navigation" class="nav-menu w-nav-menu"><a href="/home" class="nav-link-6 w-nav-link">Home</a><a href="/streaming" class="nav-link-6 w-nav-link"><img src='./assets/SV.png'/></a><a href="/historical" class="nav-link-7 w-nav-link">Historical</a><a href="/manage" class="nav-link-8 w-nav-link">Manage</a><a href="/about" class="nav-link-10 w-nav-link">About</a><a onClick={this.signOut} class="nav-link-9 w-nav-link">Sign Out</a></nav>
					...
					<div id='topBar'>
						<div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
							<div class="container w-container"><a href="/" class="nav-link w-nav-link">Schulich Velocity</a>
								<nav role="navigation" class="nav-menu w-nav-menu"><a href="/home" class="nav-link-6 w-nav-link">Home</a><a href="/streaming" class="nav-link-6 w-nav-link">Streaming</a><a href="/historical" class="nav-link-7 w-nav-link">Historical</a><a href="/manage" class="nav-link-8 w-nav-link">Manage</a><a href="/about" class="nav-link-10 w-nav-link">About</a><a href="signin" class="nav-link-9 w-nav-link">Sign In</a></nav>
								<div class="menu-button w-nav-button">
									<div class="icon w-icon-nav-menu"></div>
								</div>
							</div>
